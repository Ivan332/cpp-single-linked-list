...
public:
    ...
    [[nodiscard]] ConstIterator end() const noexcept {
        BasicIterator<const Type> it_end;
        while (it_end.node_) {
            ++it_end;
        }
        return it_end;
    ...
    SingleLinkedList(const SingleLinkedList& other) {
        if (size_ == 0 && head_.next_node == nullptr) {
            ...
            auto pos = ConstIterator{ &copy.head_ };
            for (Type value : other) {
                pos = InsertAfter(pos, value);
            }
            copy.size_ = other.size_;
            swap(copy);
        }
    }
    ...
    void PushFront(const Type& value) {
        this->head_.next_node = new Node(value, head_.next_node);
        ++size_;
    }
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        ...
        Node* new_value = new Node(value, pos.node_->next_node);
        pos.node_->next_node = new_value;
        ++size_;
    ...
    void PopFront() noexcept {
        ...
        Node* pop_value = head_.next_node;
        if (!pop_value) {
            return;
        }
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        assert(pos.node_ != nullptr);
        Node* erase_value = pos.node_->next_node;
        if (erase_value)
        {
    ...
    void Clear() noexcept {
        ...
        {
            Node* link = head_.next_node->next_node;
            delete head_.next_node;
            head_.next_node = link;
        }
        size_ = 0;
    }
